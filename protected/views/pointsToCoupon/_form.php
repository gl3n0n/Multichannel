...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,  'PointsRequired'); ?>
		<?php echo $form->textField($model,'PointsRequired',array(
			'style' => 'width:100px;',
			'maxlength'=>20
		));
		?>
		<?php echo $form->error($model,'PointsRequired'); ?>
	</div>
	<div class="row">
		<?php echo $form->labelEx($model,  'CouponValue'); ?>
		<?php echo $form->textField($model,'CouponValue',array(
			'style' => 'width:100px;',
			'maxlength'=>20
		));
		?>
