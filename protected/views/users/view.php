<div>
	<div>
		...
		<p>
                    ...
                    <a href="<?php echo Yii::app()->createAbsoluteUrl('users/edit', array('id'=>$data['UserId'])); ?>">Edit Details</a>
                </p>
	</div>
	...
	<div>
		<dl>
                        <dt>Username</dt>
                        <dd><i><?php echo $data['Username'] ?: '&nbsp;'; ?></i></dd>

			<dt>First Name</dt>
			<dd><i><?php echo $data['FirstName'] ?: '&nbsp;'; ?></i></dd>

                        <dt>Middle Name</dt>
                        <dd><i><?php echo $data['MiddleName'] ? : '&nbsp;'; ?></i></dd>

			<dt>Last Name</dt>
			<dd><i><?php echo $data['LastName'] ?: '&nbsp;'; ?></i></dd>

                        <dt>Email</dt>
                        <dd><i><?php echo $data['Email'] ?: '&nbsp;'; ?></i></dd>

                        <dt>Contact Number</dt>
                        <dd><i><?php echo $data['ContactNumber'] ?: '&nbsp;'; ?></i></dd>

			<dt>AccessType</dt>
			<dd><i><?php echo $data['AccessType'] ?: '&nbsp;'; ?></i></dd>

			<dt>Status</dt>
			<dd><i><?php echo $data['Status'] ?: '&nbsp;'; ?></i></dd>

			<dt>Last Updated</dt>
			<dd><i><?php echo $data['DateUpdated'] ?: '&nbsp;'; ?></i></dd>
