...
class Points extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('ClientId, BrandId, CampaignId, ChannelId, Value, PointAction, PointCapping', 'length', 'max'=>11),
			array('Status', 'length', 'max'=>8),
			array('PointCapping', 'in', 'range'=>array('DAILY', 'NONE')),
			array('From, To', 'date', 'format'=>'yyyy-MM-dd'),
