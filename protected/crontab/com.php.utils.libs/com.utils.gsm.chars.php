...
*              
*/
function is_7Bit_GSM_chars($str='') 
{
	//init
	$j   = 0;
	$tot = strlen($str); 
	...
	{ 
		...
		if (@in_array($char,$gsm)) 
			$j++; 
		 
	} 
	
	debug("is_7Bit_GSM_chars():: GSM-7Bit = [ $str / $tot / $j ]");
	 
	//give it back ;-)
	return ($j < $tot ) ? (false) : (true); 	 
